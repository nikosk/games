...
A first playable puzzle now lives in `games/railway-workshop/`. It has limited straight and curved pieces, rotation, removal, undo, route highlighting, a moving train, original sound effects, and a success celebration. Its responsive canvas fills the viewport, the map dominates landscape screens, and the compact controls sit in a right-side panel with a fullscreen toggle. The original is preserved at `classic/train-tracks.html`.
