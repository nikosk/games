...
- Do not spin up subagents unless the user specifically asks you to. When the user asks, use subagents for all substantial research, implementation, and review work in this repository.
